   ...
   <div>
        ...
        <nav id="navbar">
            ...
            <ul class="nav navbar-nav">
               <!--  <li><a href="./aboutUsNoLog.jsp">About Us</a></li> -->
                <li><a href="index">Log In/Sign Up</a></li>
            </ul>
        </nav>
    </div>
    <div>
    ...
    <div id="infoDiv"> 
        ...
        a bit simpler and easier to use. The couple who didn't use an app said they wish they had. <br>
        Since then, the idea to create Bambii was in my mind and that is why Bambii exists. To make the lives of 
        new parents easier while maintaining all the important development and milestones for their baby.
    </div>
    <div id="resources">
        Resources Used:
